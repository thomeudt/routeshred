# Positioning vs. Komoot

## Purpose of this Document

This document describes how to position RouteShred in comparison to Komoot.

Note: Komoot is a strong product. This positioning is based on differentiation, not devaluation.
...
- Ambitious road and gravel riders with high expectations for routing precision
- Clubs and communities that need collaborative group ride workflows
- Privacy- and sovereignty-focused users
- Teams and organizations that want to control hosting and integrations

## Differentiation in 5 Sentences
...
## Where Komoot Is Typically Stronger

- Discovery/community reach and established marketplace effects
- Lower entry barrier for casual users
- Mature content and consumer ecosystem elements

## Messaging Building Blocks

### Website Hero

- Open-source bike routing with full data control.
- Plan precise road and gravel routes on your own instance.
- Built for riders, teams, and clubs that want more than standard apps.
...
Not "better than Komoot" for everyone.
Better for teams and riders who prioritize customization, privacy, and infrastructure independence.

## ICP (Ideal Customer Profile)

- Runs recurring group rides (club, team, community)
- Has technical support or interest in self-hosting
- Values data sovereignty
- Already uses GPX/FIT/Wahoo/Garmin workflows

## Objections and Responses

- "Self-hosting is too complex."
  - Response: Docker-based setup path, clear docs, and optional operation by technically experienced admins.
- "Komoot has more users."
  - Response: RouteShred optimizes for your own workflow and control, not mass-platform effects.
- "We need quick results."
  - Response: Presets/personas for fast onboarding, depth only when needed.

## Do / Don't in Communication

Do:
- Compare factually
- Focus on target audience and use cases
- Acknowledge Komoot's strengths, then differentiate

Don't:
- Avoid absolute "we are better at everything" claims
- Avoid unverified performance or market claims
- Avoid aggressive or dismissive competitor rhetoric

## Recommended Placement in the Project

- Link from the README under "User Manual" or "Documentation"
- Optionally use as a base for landing-page copy and product messaging
- Update regularly when features or roadmap priorities change
