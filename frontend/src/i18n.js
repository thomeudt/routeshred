const translations = {
  de: {
    ...
    route: {
      ...
      setupSections: {
        heroEyebrow: 'Profilwerkstatt',
        heroTitle: 'Garage & Fahrerwerte',
        heroHint: 'Profile bauen, Werte pflegen.',
        locations: 'Strecke',
        bike: 'Bike-Profil',
        bikePlanHint: 'Rad für diese Strecke',
        bikeHint: 'Eigene Bike-Profile erstellen, bearbeiten und verwalten. Das aktive Rad für eine Strecke wählst du im Planen-Tab.',
        user: 'Fahrerprofil',
    ...
    map: {
      ...
      gpsUnavailable: 'GPS wird von diesem Gerät/Browser nicht unterstützt.',
      gpsRequiresHttps: 'GPS funktioniert nur über HTTPS oder localhost.',
      gpsPermissionDenied: 'GPS-Zugriff wurde blockiert. Bitte Standort für diese Website in Safari/iOS erlauben.',
  ...
  en: {
    ...
    route: {
      ...
      setupSections: {
        heroEyebrow: 'Profile workshop',
        heroTitle: 'Garage & rider numbers',
        heroHint: 'Build profiles and maintain rider values.',
        locations: 'Route',
        bike: 'Bike profile',
        bikePlanHint: 'Bike for this route',
        bikeHint: 'Create, edit and manage custom bike profiles. The active bike for a route is selected in the Plan tab.',
        user: 'Rider profile',
    ...
    map: {
      ...
      gpsRequiresHttps: 'GPS only works over HTTPS or localhost.',
